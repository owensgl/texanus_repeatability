...
directory <- "/media/drive_5_usb/owens/bin/texanus/2021/slim_sims/underdom"
...
pdf("2021/selection_simulations.underdom.v2.pdf",height=5,width=5)
...
pdf("2021/recombination_simulations.underdom.v2.pdf",height=5,width=5)
